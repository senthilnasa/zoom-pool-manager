...
class MeetingStateMachine
{
    ...
    protected const ALLOWED_TRANSITIONS = [
        ...
        'allocating' => ['scheduled', 'started', 'ended', 'completed', 'failed', 'waitlisted', 'cancelled'],
        'waitlisted' => ['allocating', 'cancelled'],
        'failed' => ['allocating', 'cancelled'],
        'scheduled' => ['started', 'ended', 'completed', 'allocating', 'cancelled'],
        'started' => ['ended', 'completed', 'cancelled'],
